...
<?php tpl_flush() ?>
<body class="<?php echo $TPL->getClasses() ?>" style="font-size: 150%;" data-page-id="<?php echo $ID ?>"><div class="dokuwiki"><?php /* CSS class for Plugins and user styles */ ?>
    ...
    <main role="main" class="dw-container pb-5 dokuwiki container<?php echo ($TPL->getConf('fluidContainer')) ? '-fluid mx-5' : '' ?>">
        ...
        <div class="row">
            ...
            <article id="dokuwiki__content" class="<?php echo $TPL->getContainerGrid() ?>" itemscope itemtype="http://schema.org/<?php echo $TPL->getConf('schemaOrgType'); ?>" itemref="dw__license" style="width:70%">
